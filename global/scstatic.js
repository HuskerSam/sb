/* Singleton Controller for static application configuration */
'use strict'
class SCStatic {
  constructor() {
    this.bindingFields = {};
    this.bindingFields['mesh'] = [{
      title: 'Title',
      fireSetField: 'title',
      uiObjectField: null,
      group: 'title'
