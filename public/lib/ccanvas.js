...
export default class cCanvas {
  constructor(parent) {
    ...
    //TOFIX camera height
    // ['cameraHeightSave' + this.rootBlock.blockKey]
    ...
    this.canvas.addEventListener('click', e => {
      if (this.closeMenusOnClick)
        this.parent.closeHeaderBands(true);
      if (this.parent.context.camera) {
  ...
  fovSliderChange() {
    ...
    this.parent.sets.profile.update({
      ['cameraFOVSave' + this.rootBlock.blockKey]: this.fovSlider.value
    }, 'user');
  ...
  arcRangeSliderChange(e) {
    ...
    let val = this.cameraSliderValue(this.arcRangeSlider.value);
    this.parent.sets.profile.update({
      ['cameraRadiusSave' + this.rootBlock.blockKey]: val
    });
    this._updateCameraRangeSlider();
  }
  ...
  cameraHeightChange() {
    ...
    this.parent.sets.profile.update({
      ['cameraHeightSave' + this.rootBlock.blockKey]: this.heightSlider.value
    });
  ...
  cameraChangeHandler() {
    ...
    if (this.cameraSelect.value === 'reset') {
      ...
      this.parent.sets.profile.update({
        ['cameraPositionSave' + this.rootBlock.blockKey]: '3,15,-15',
        ['cameraRadiusSave' + this.rootBlock.blockKey]: false,
        ['cameraTargetSave' + this.rootBlock.blockKey]: '0,0,0',
        ['cameraFOVSave' + this.rootBlock.blockKey]: '.8'
      });
  ...
  _clearVideoURL() {
    if (gAPPP.a.profile.videoClearURL) {
      this.parent.sets.block.getCache(this.rootBlock.blockKey).videoURL = '';
      this.parent.sets.block.update({
        videoURL: ''
  ...
  __saveCameraPosition(cp, tp) {
    ...
    this.parent.sets.profile.update({
      ['cameraPositionSave' + this.rootBlock.blockKey]: cp,
      ['cameraRadiusSave' + this.rootBlock.blockKey]: camera.radius,
      ['cameraTargetSave' + this.rootBlock.blockKey]: tp,
      ['cameraFOVSave' + this.rootBlock.blockKey]: camera.fov
    });
  }
  hide() {
